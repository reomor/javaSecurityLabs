...
4. [Работа с СУБД](#sqli)
5. [Реализация механизмов контроля доступа](#mfac)
6. [Обработка запросов на изменение данных (защита от CSRF)](#csrf)
...
### Подробное руководство
#### Часть 1. Подготовка
1. Откройте проект _lab-03-xss_
2. Запустите проект. Зайдите на http://localhost:8091/
...
```
4. Добавьте код, санитизирующий тест поста и разрешающий использование тегов
...
```
5. Пересоберите проект. Заполните тест поста, как:
```HTML
...
<b>TEST BOLD</b>
```
6. Отправьте пост. Посмотрите исходный код страницы. _Как выводится тест поста на странице?_
...
### Подробное руководство
#### Часть 1. Подготовка
1. Откройте проект _lab-04-sqli_
2. Запустите проект. Зайдите на http://localhost:8091/
...
## <a name="mfac"></a>Задание №5. Реализация механизмов контроля доступа
### Описание
...
## <a name="csrf"></a>Задание №6. Обработка запросов на изменение данных (защита от CSRF)
### Описание
...
### Основная часть
#### Часть 1. Подготовка
1. Откройте проект _lab-csrf_
2. Запустите проект. Зайдите на http://localhost:8091/
3. Залогитесь под пользователем _user_ с паролем _password_
...
перевод денег.
2. Сгенерируйте страницу для эксплуатации CSRF:
_Engagement tools -> Generate CSRF PoC_
3. Измените поле _to_ на _HACKER_, а поле _amount_ на _31337_
4. Протестируйте в браузере _Test in browser_, предварительно залогинившись
