...
5. [Использование небезопасных компонентов](#known_vuln)
6. [Реализация механизмов контроля доступа](#mfac)
...
## <a name="csrf"></a>Задание №7. Обработка запросов на изменение данных (защита от CSRF)
### Описание
